  ...
  return (
    <>
      <div className="flex justify-center flex-col gap-4 items-center text-white h-[44vh] px-5 md:px-0 text-xs md:text-base  ">
        <div className="font-bold flex gap-6 md:gap-20 md:text-5xl justify-center items-center text-3xl">Get Me a Tea <span><img className="invertImg" src="/tea.gif" width={88} alt="" /></span></div>
      ...
      <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
        ...
        <p className="text-center text-gray-400 mb-8 max-w-2xl">Watch this tutorial to learn how crowdfunding platforms help creators fund their projects</p>
        {/* Responsive youtube embed  */}
        <div className="w-[90%] h-[40vh] md:w-[50%] md:h-[40vh] lg:w-[50%] lg:h-[40vh] xl:w-[50%] xl:h-[40vh] flex items-center justify-center">
